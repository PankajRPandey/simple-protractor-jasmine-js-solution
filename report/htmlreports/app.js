...
app.controller('ScreenshotReportController', ['$scope', '$http', 'TitleService', function ($scope, $http, titleService) {
    ...
    var results = [
    {
        "description": "should greet the named user|Env : dev - angularjs homepage",
        "passed": true,
        "pending": false,
        "os": "windows",
        "sessionId": "ee77912aa1d20372cd0cf8b02ca7fb97",
        "instanceId": 13408,
        "browser": {
            "name": "chrome",
